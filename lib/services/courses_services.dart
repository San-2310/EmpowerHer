  ...
  Stream<bool> isUserEnrolled(String userId, String courseId) {
    return _firestore
      ...
      List<String> enrolledUsers =
          List<String>.from(snapshot.get('enrolledUsers') ?? []);
  ...
  Stream<bool> isUserCompleted(String userId, String courseId) {
    return _firestore
      ...
      List<String> completedUsers =
          List<String>.from(snapshot.get('completedUsers') ?? []);
  ...
  Future<void> enrollInCourse(String userId, String courseId) async {
    await _firestore.runTransaction((transaction) async {
      ...
      if (courseSnapshot.exists) {
        List<String> enrolledUsers =
            List<String>.from(courseSnapshot.get('enrolledUsers') ?? []);
